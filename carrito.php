...
if(isset($_GET['id']) && is_numeric($_GET['id'])){
    ...
    $pelicula = new Kawschool\Teclado;
    ...
    if(isset($_SESSION['carrito'])){ //SI EL CARRITO EXISTE
        ...
        if(array_key_exists($id,$_SESSION['carrito'])){
            actualizarTeclado($id);
        }else{
            //  SI EL CARRITO NO EXISTE EN EL CARRITO
            agregarTeclado($resultado, $id);
        }
...
<html lang="en">
  <head>
    ...
    <title>Tienda de Teclados</title>
      ...
      <div class="container">
        <div class="navbar-header">
          <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar">
            <span class="sr-only">Tienda de Teclados</span>
            <span class="icon-bar"></span>
            <span class="icon-bar"></span>
            <span class="icon-bar"></span>
          </button>
          <a class="navbar-brand" href="index.php">Teclados mecanicos</a>
        </div>
                      ...
                      ?>
                        <tr>
                            <form action="actualizar_carrito.php" method="post">
                                ...
                                <td>
                                <input type="hidden" name="id"  value="<?php print $value['IDteclado'] ?>">
                                ...
                                <td>
                                    ...
                                    <a href="eliminar_carrito.php?id=<?php print $value['IDteclado']  ?>" class="btn btn-danger btn-xs">
